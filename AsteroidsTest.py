...
def gameLoop(game):
    ...
    if key[pygame.K_LEFT]:
        ...
        bullet["pos"]["x"] = game["ship"]["rect"].center[0]
        bullet["pos"]["y"] = game["ship"]["rect"].center[1]
...
#    screen.blit(rotated_surface, draw_centre)
    ...
    black = (0, 0, 0)
    #draw text!
    text = font.render("you have " + str(ship["health"]) + " lives", True,white,black)
    ...
    if bullet["fired"] == True:
        bullet_rect = bullet["image"].get_rect()
